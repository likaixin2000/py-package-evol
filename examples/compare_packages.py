...
def main():
    ...
    try:
        for package in packages:
            ...
            print(f"  - {summary['total_versions']} versions, "
        ...
        print("\\nSummary Comparison:")
        print("Package".ljust(15) + "Versions".ljust(10) + "Changes".ljust(10) + "APIs Added".ljust(12) + "APIs Removed")
        print("-" * 60)
        
        for package, result in results.items():
            summary = result.generate_summary()
            print(f"{package}".ljust(15) + 
