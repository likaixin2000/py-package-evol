...
class TestPackageAnalyzer(unittest.TestCase):
    ...
    def test_analyze_package_success(self, mock_calculate_changes, mock_analyze_version):
        ...
        # Mock fetcher
        self.analyzer.fetcher.get_version_range = Mock(return_value=[self.version1, self.version2])
