...
class TestAPIElement(unittest.TestCase):
    ...
    def test_private_api_detection(self):
        ...
        magic_element = APIElement(
            name="__magic_method__",
            type=APIType.METHOD,
            module_path="test.module"
        )
        
        self.assertFalse(magic_element.is_private)  # Magic methods are not considered private
...
class TestAnalysisResult(unittest.TestCase):
    ...
    def test_get_api_changes_filter_by_api_type(self):
        ...
        self.assertTrue(all(c.element.type == APIType.FUNCTION for c in function_changes))
    ...
    def test_get_api_lifecycle(self):
        ...
        self.assertEqual(len(lifecycle['versions_present']), 2)  # Present in both versions
