...
class SourceParser:
    ...
    def parse_package(self, package_path: Path, package_name: str) -> List[APIElement]:
        ...
        for file_path in python_files:
            try:
                ...
                module_path = self._get_module_path(file_path, package_path, package_name)
    ...
    def _get_module_path(self, file_path: Path, package_path: Path, package_name: str) -> str:
    ...
    def _extract_type_hints(self, node: Union[ast.FunctionDef, ast.AsyncFunctionDef]) -> Dict[str, str]:
